...
<aside id="filters">
    ...
    <div class="filter-list">
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="8" /><span
        ...
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="9" /><span
                class="glyphicon glyphicon-home"></span> <span class="filter-name">pojištění Domácnosti</span></a><a href="#delete-modal"
                role="button" data-toggle="modal" class="btn btn-link delete"><span data-toggle="tooltip" title="Smazat"
                class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="10" /><span
        ...
        <div class="btn-group filter">
            <a class="btn btn-link btn-large filter-label" type="button"><input name="filter-id" type="hidden" value="11" /><span
                class="glyphicon glyphicon-road"></span> <span class="filter-name">Havarijní pojištění</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="12" /><span
                class="filter-name">pojištění Na dožití</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="13" /><span
                class="glyphicon glyphicon-heart"></span> <span class="filter-name">Nemocenské pojištění</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="14" /><span
                class="filter-name">pojištění Odpovědnosti za škodu</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link filter-label" type="button"><input name="filter-id" type="hidden" value="15" /><span
                class="filter-name">Penzijní připojištění</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link btn-large filter-label" type="button"><input name="filter-id" type="hidden" value="16" /><span
                class="glyphicon glyphicon-road"></span> <span class="filter-name">Povinné ručení</span></a>
        </div>
        <div class="btn-group filter">
            <a class="btn btn-link btn-mini filter-label" type="button"><input name="filter-id" type="hidden" value="17" /><span
        ...
        <div class="btn-group filter">
            <a class="btn btn-link btn-mini filter-label" type="button"><input name="filter-id" type="hidden" value="18" /><span
        ...
        <div class="btn-group filter">
            <a class="btn btn-success filter-label selected-filter" type="button"><input name="filter-id" type="hidden" value="19" /><span
        ...
        <div class="btn-group filter">
            <a class="btn btn-link btn-small filter-label" type="button"><input name="filter-id" type="hidden" value="20" /><span
    ...
    <footer>
        <div class="input-group" id="add-filter">
            <span data-toggle="tooltip" title="Název nového filtru" data-placement="top"><input name="filter-name" type="text"
