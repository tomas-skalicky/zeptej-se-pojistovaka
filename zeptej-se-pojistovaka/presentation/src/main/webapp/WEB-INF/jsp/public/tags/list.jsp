    ...
    <div class="tag-list">
        <div class="btn-group tag">
            <a class="btn btn-link tag-label" type="button"><input name="tagId" type="hidden" value="8" /><span
                ...
                title="<spring:message code="delete" />" class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
        <div class="btn-group tag">
        ...
        <div class="btn-group tag">
            <a class="btn btn-link tag-label" type="button"><input name="tagId" type="hidden" value="10" /><span class="tag-name">Důchodové
                ...
                data-toggle="tooltip" title="<spring:message code="delete" />" class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
        <div class="btn-group tag">
        ...
        <div class="btn-group tag">
            <a class="btn btn-link btn-mini tag-label" type="button"><input name="tagId" type="hidden" value="17" /><span
                ...
                class="btn btn-link btn-mini delete"><span data-toggle="tooltip" title="<spring:message code="delete" />"
        ...
        <div class="btn-group tag">
            <a class="btn btn-link btn-mini tag-label" type="button"><input name="tagId" type="hidden" value="18" /><span
                ...
                data-toggle="modal" class="btn btn-link btn-mini delete"><span data-toggle="tooltip"
                title="<spring:message code="delete" />" class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
        <div class="btn-group tag">
            <a class="btn btn-success tag-label selected-tag" type="button"><input name="tagId" type="hidden" value="19" /><span
                ...
                role="button" data-toggle="modal" class="btn delete selected-tag"><span data-toggle="tooltip"
                title="<spring:message code="delete" />" class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
        <div class="btn-group tag">
            <a class="btn btn-link btn-small tag-label" type="button"><input name="tagId" type="hidden" value="20" /><span
                ...
                role="button" data-toggle="modal" class="btn btn-link btn-small delete"><span data-toggle="tooltip"
                title="<spring:message code="delete" />" class="glyphicon glyphicon-remove" data-container="body"></span></a>
        </div>
    </div>
    <footer>
        <div class="input-group" id="add-tag">
            <span data-toggle="tooltip" title="<spring:message code="tags.new.name.title" />" data-placement="top"><input
                name="tagName" type="text" placeholder="<spring:message code="tags.new.name.placeholder" />" class="form-control" /></span> <span
                class="input-group-btn">
                <button class="btn btn-info" type="button" data-toggle="tooltip" title="<spring:message code="add" />" data-container="body">
